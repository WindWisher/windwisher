...
class AppStrings {
  ...
  static const _values = <String, Map<String, String>>{
    'es': {
      ...
      'passwordUpdated': 'Contrasena actualizada. Ya puedes iniciar sesion.',
      'invalidRecoveryLink': 'El enlace de recuperacion no es valido o ha caducado.',
    ...
    'en': {
      ...
      'invalidRecoveryLink': 'The recovery link is invalid or has expired.',
    ...
    'de': {
      ...
      'invalidRecoveryLink': 'Der Wiederherstellungslink ist ungueltig oder abgelaufen.',
    ...
    'fr': {
      ...
      'passwordUpdated': 'Mot de passe mis a jour. Tu peux maintenant te connecter.',
      'invalidRecoveryLink': 'Le lien de recuperation est invalide ou a expire.',
    ...
    'it': {
      ...
      'invalidRecoveryLink': 'Il link di recupero non e valido o e scaduto.',
    ...
    'zh': {
      ...
      'invalidRecoveryLink': '恢复链接无效或已过期。',
      'backToLogin': '返回登录',
    ...
    'ar': {
      ...
      'passwordTooShort': 'يجب ان تحتوي كلمة المرور على 6 احرف على الاقل.',
      'passwordUpdated': 'تم تحديث كلمة المرور. يمكنك تسجيل الدخول الآن.',
      'invalidRecoveryLink': 'رابط الاستعادة غير صالح او منتهي الصلاحية.',
  ...
  String get passwordTooShort => _value('passwordTooShort');
  String get passwordUpdated => _value('passwordUpdated');
  String get invalidRecoveryLink => _value('invalidRecoveryLink');
