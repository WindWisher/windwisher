    ...
    return ProfileKpiDialogData(
      sections: [
        ProfileKpiSectionData(
          title: 'Volumen',
          description:
              'Cuanta actividad acumula el rider a lo largo del tiempo.',
          items: [
            ProfileKpiItemData(
        ...
        ProfileKpiSectionData(
          ...
          items: [
            ...
            const ProfileKpiItemData(
              ...
              hydrated: false,
              pendingSourceLabel:
                  'Pendiente desde sesiones agrupadas por fecha',
            ),
            const ProfileKpiItemData(
              label: 'Mejor semana',
              value: '--',
              hydrated: false,
              pendingSourceLabel:
                  'Pendiente desde sesiones agrupadas por semana',
            ),
            const ProfileKpiItemData(
      ...
      contextRows: [
        ...
        ProfileDetailRowData(
          'Mejor spot',
          kpis.bestSpotLabel,
          hydrated: kpis.bestSpotLabel != '--',
        ),
        ProfileDetailRowData(
          'Ultima sesion destacada',
          kpis.latestSessionLabel,
          hydrated: kpis.latestSessionLabel != '--',
        ),
        ProfileDetailRowData(
          'Ultimo comentario destacado',
          kpis.latestCommentLabel,
          hydrated: kpis.latestCommentLabel != '--',
        ),
        ProfileDetailRowData(
          'Hilo destacado',
          kpis.featuredThreadLabel,
          hydrated: kpis.featuredThreadLabel != '--',
        ),
      ],
    );
  }
