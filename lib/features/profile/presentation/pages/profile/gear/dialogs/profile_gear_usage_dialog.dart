                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildDetailRow(
                              'Ultima actualizacion cometa',
                              lastKite,
                            ),
                            _buildDetailRow(
                              'Ultima actualizacion tabla',
                              lastBoard,
                            ),
                            _buildDetailRow(
                              'Ultima actualizacion barra',
                              lastBar,
                            ),
                            _buildDetailRow(
                              'Ultima actualizacion arnes',
                              lastHarness,
                            ),
                            _buildDetailRow(
                              'Ultima actualizacion traje',
                              lastWetsuit,
                            ),
                            _buildDetailRow(
      ...
      child: Column(
        ...
        children: [
          ...
          Align(
            ...
            child: TextButton(onPressed: onTap, child: const Text('Detalles')),
          ),
        ],
      ),
    );
